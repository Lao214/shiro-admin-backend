...
import com.example.shiro.filter.AuthFilter;
import com.example.shiro.utils.AuthRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager defaultWebSecurityManager){
        ...
        filterMap.put("/shiro/user/login","anon");  //放行login接口
        filterMap.put("/shiro/user/logout","anon");    //放行logout接口
